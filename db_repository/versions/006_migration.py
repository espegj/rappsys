...
def upgrade(migrate_engine):
    ...
    pre_meta.tables['project'].columns['connection_id'].drop()
    pre_meta.tables['user'].columns['connection_id'].drop()
...
def downgrade(migrate_engine):
    ...
    pre_meta.bind = migrate_engine
    post_meta.bind = migrate_engine
    pre_meta.tables['project'].columns['connection_id'].create()
    pre_meta.tables['user'].columns['connection_id'].create()
